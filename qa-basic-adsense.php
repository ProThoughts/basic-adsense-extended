...
class qa_basic_adsense
{
	...
	$fromhandlehandles = array('lavender', 'The Oracle'); //users opted in by request to see ads
	$divstyle='';
	if ( qa_get_logged_in_level() <= QA_USER_LEVEL_APPROVED || in_array($fromhandle, $fromhandlehandles) ) 
{
		switch ($region) {
